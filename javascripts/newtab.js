...
(function() {
  ...
  ChromeClassicNewTab = (function() {
    ...
    AppsList = (function() {
      AppsList.BUILD_IN_APPS = ["blpcfgokakmgnkcojhhkbfbldkacnbeo", "coobgpohoikkiipiblmjeljniedjpjpf", "pjkljhegncpnkpknbcohdijeoejaedia"];
          ...
          return chrome.management.getAll(function(extensions) {
            ...
            _this.apps = (function() {
              ...
              for (_i = 0, _len = extensions.length; _i < _len; _i++) {
                ...
                if (extension.isApp && (extension.enabled || (_ref = extension.id, __indexOf.call(AppsList.BUILD_IN_APPS, _ref) >= 0))) {
      ...
      AppsList.prototype.onWindowResized = function() {
        var effectiveWidth, fontSize, imageWidth, itemMargins, listPadding;
        effectiveWidth = document.width < 600 ? 640 : document.width;
        ...
        $(this.list).find(".app-link").css({
          width: imageWidth,
          paddingTop: "" + imageWidth + "px"
        });
        $(this.list).find(".app-item").css({
          margin: "" + itemMargins[0] + "px " + itemMargins[1] + "px"
        });
        $(this.list).find(".app-link span").css({
